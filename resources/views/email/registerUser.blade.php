    ...
    padding-left: 32px;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding: 5px; font-size: 15px; font-family: 'rawline', sans-serif; line-height: 20px; color: #555555;">
                            <h1 style="margin: 0 0 10px; text-align: left; font-size: 27px; font-family: 'rawline', sans-serif; line-height: 30px; color: #fff; font-weight: bold;padding-left: 30px;">{{ CTrans::trans('pages.header.welcome', 'es') }}</h1>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding: 0px 35px; background-color: #000;">
                <p style="color: #FFF; font-size: 18px; font-family: 'rawline', sans-serif; text-align: left;font-weight: Light;">{{ CTrans::trans('pages.register.congrats', 'es') }}<span style="color: #FFF; font-size: 18px; font-family: 'rawline', sans-serif;font-weight: bold;"> {{ CTrans::trans('pages.register.userReg', 'es') }} </span> {{ CTrans::trans('pages.register.userRegComplement', 'es') }} castro Exclusive Residences.</p>
            </td>
        </tr>
            ...
            <td valign="middle" style="text-align: center; padding: 10px 40px; font-size: 21px; font-family: 'rawline', sans-serif; line-height: 20px; color: #fff;background-color: #000;">
                <div style="margin: 0; padding: 20px 15px 0px 15px;">
                    <div style="padding-bottom: 20px;color: #FFF; font-size: 17px; font-family: 'rawline', sans-serif; text-align: justify;font-weight: Light;">
                        ...
                        <div style="padding-top: 5px;"><span style="font-size: 16px ;font-family: 'rawline';font-weight: bold;color: #fff;">{{ CTrans::trans('pages.register.user', 'es') }}: </span> {{ $user['email'] }} </div>
                    ...
                    @if(isset($tempPassword))
                        <div style="padding-bottom: 20px;padding-bottom: 20px;color: #FFF; font-size: 17px; font-family: 'rawline', sans-serif; text-align: justify;font-weight: Light;">
                            <img src="{{ asset('storage/image/emails-registerUser-clave.svg') }}" width="30" style="float: left;padding:5px 20px 0px 5px;">
                            <span style="font-size: 16px;font-family: 'rawline';font-weight: bold;color: #fff;">{{ CTrans::trans('pages.register.password', 'es') }}:</span> {{ $tempPassword }}
