...
<center style="width: 100%; background-color: #fff;">
    ...
    <table valign="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td valign="bottom" style="text-align: left; padding: 10px 40px; font-family: sans-serif; font-size: 15px; font-family: 'rawline', sans-serif;line-height: 20px; color: #ffffff;">
                                <p><img src="{{ asset('storage/image/email-rateService-SVG-Logo Castro.svg') }}" width="170"></p>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding: 5px 40px; font-size: 15px; font-family: 'rawline', sans-serif; line-height: 20px;">
                            <h1 style="margin: 0 0 10px; text-align: left; font-size: 25px; font-family: 'rawline', sans-serif; line-height: 30px; color: #fff; font-weight: bold;">Para nosotros tu opinión es importante</h1>
                        </td>
                    </tr>

                    <tr>
                        <td style="padding: 0px 40px; text-align: center; background-color: #000;">
                            <p style="color: #FFF; font-size: 15px; font-weight: 300; font-family: 'rawline', sans-serif; text-align: left;">Nos encantaría que tú y tus acompañantes <b>valoren la estancia</b>. ¡No te quitará mucho tiempo!</p>
                        </td>
                    </tr>
        ...
        <tr>
            <td valign="top" style=" background-color: #000;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <!-- Column : BEGIN -->
                        <td class="stack-column-center">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="130%">
                                <tr>
                                    <td style="padding: 10px 0px 5px 40px; font-size: 15px; font-family: 'rawline', sans-serif; line-height: 20px;" valign="middle">
                                        <h1 style="margin: 0 0 10px; text-align: left; font-size: 23px; font-family: 'rawline', sans-serif; line-height: 30px; color: #fff; font-weight: bold;">castro Exclusive Residences</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <!-- Column : BEGIN -->
                        <td class="stack-column-center">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="70%">
                                <tr>
                                    <td style="text-align: right; color: #fff;" valign="middle">
                                        <img src="{{ asset('storage/image/email-rateService-SVG-Valoracion_02.svg') }}" width="190" alt="valoracion">
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <tr>
            <td style="padding: 15px 20px 10px 20px;; text-align: center; background-color: #000;">
                <!-- Button : BEGIN -->
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                    <tr>
                        <td class="button-td button-td-primary">
                            <a class="button-a button-a-primary" href="#" style="background: #ED9C28; font-size: 21px; font-family: 'rawline', sans-serif; font-weight: bold; text-decoration: none; padding: 8px 30px 10px 30px; color: #000; display: block; border-radius: 50px;">Valora tu estancia en
                                <span style="color:#BC0926;">Google+</span></a>
                        </td>
                    </tr>
                </table>
                <hr width="92%;" style="margin-top: 30px; border-color: #787878; border-bottom-width: 1px;">
            </td>
        </tr>
                    ...
                    <tr>
                        ...
                        <td width="22.33%" class="stack-column-center">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/image/email-rateService-SVG-Botones.svg') }}" height="230" width="210" style="margin-top: 35px;margin-bottom:-4px">
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="color: #FFF;padding-bottom: 20px;">
                                        ...
                                        <div>
                                            <img src="{{ asset('storage/image/email-rateService-SVG-Telefono.svg') }}" width="20" style="float:left;padding: 5px 10px 0px 3px;"> <span style="font-size: 13px; font-family: 'rawline', sans-serif;">welcome@castroexclusiveresidences.com</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding: 10px; text-align: center;font-size: 10px; font-family: 'rawline', sans-serif; color: #fff;">
                                        ...
                                        <div style="padding-top:5px">
                                            <img src="{{ asset('storage/image/email-rateService-SVG-Instagram.svg') }}" width="20" style="float: left;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 10px 0px 10px 40px; text-align: right">
                                        <a href="#"><img src="{{ asset('storage/image/email-rateService-SVG-Logo Castro.svg') }}" width="130" height="170" alt="logo-castro" border="0" class="fluid" style="height: auto;"></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
